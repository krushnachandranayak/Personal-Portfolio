      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6">
            <p>Hello! I’m a passionate Full Stack Web Developer with a focus on creating user-friendly and responsive websites. My skills include HTML, CSS, JavaScript, React, and more. I love building applications that solve real-world problems and continuously learning new technologies.</p>
          </div>
          <div className="col-md-6">
